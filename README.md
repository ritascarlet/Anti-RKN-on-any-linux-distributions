# Простой и элегантый способ обойти все блокировки от РКН на большинстве платформ 
## Список доступных гайдов: 
Linux (большинство популярных дистрибутивов)

MacOS (от High Sierra)

В планах добавить гайд на системы Bsd семейства

# Работает по принципу self-host, но я могу ошибаться, так как я не совсем профи с этих делах 
### На момент последнего коммита 23.04.25 появился простой способ с использованием Zapret (смотреть примечание №5)
...
Обновление: Теперь вы можете использовать установочный bin файл из репозитория самого приложения, так как появилась поддержка fedora и прочих rpm-based дистрибутивов
(гайд на приложение аналогичен гайду из примечания номер 1)
...
(https://github.com/sund3RRR спасибо за упаковку<3)
...
# Примечание номер 5: Zapret Discord Youtube Linux

Давно хотел написать по этому поводу примечание, но руки дошли только сейчас

[Zapret-Discord-Youtube](https://github.com/Sergeydigl3/zapret-discord-youtube-linux.git) это форк  [Zapret Discord Youtube Flowseal](https://github.com/Flowseal/zapret-discord-youtube), но адаптированный под linux

В данный момент я не могу полностью оценить работу скрипта, так как пересел на macos. Но гайд по его установке находится в репозитории [Zapret-Discord-Youtube](https://github.com/Sergeydigl3/zapret-discord-youtube-linux.git)

Если вы читаете этот гайд, а после установили себе данную фичу, то отпишитесь в пиллы или ошибки, расскажите насколько корректно оно работает) 
#  Примечание номер 6: MacOS
